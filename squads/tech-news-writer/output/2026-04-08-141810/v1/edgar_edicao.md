...
![Infográfico técnico mostrando a arquitetura de 128 especialistas do Gemma 4, destacando o fluxo de dados entre os 8 especialistas ativos e o processamento off-line em um smartphone Android.](https://venturebeat.com/wp-content/uploads/2026/04/google-gemma-4-benchmarks.png)
...
![Uma mão segurando um smartphone que exibe um editor de código agindo de forma autônoma (Gemma 4 processando), com um ícone de "Sem Internet" no topo para enfatizar a execução local — Fonte: Google Blog](https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/feature_image.jpg)
